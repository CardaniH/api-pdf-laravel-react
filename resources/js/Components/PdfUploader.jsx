...
function PdfUploader() {
    ...
    const handleMergeAndDownload = async (e) => {
        ...
        try {
            ...
            let filename = `${finalOutputName}.pdf`;
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                ...
                                <div {...getRootProps()} className={`file-drop-zone mb-6 ${isDragActive ? 'file-drop-zone-active' : ''}`}>
                                    ...
                                    {isDragActive ? (
                                        <p className="text-lg font-medium text-red-600 mb-2">¡Suelta los archivos aquí!</p>
                                    ) : (
                                        <>
                                            <p className="text-lg font-medium text-gray-700 mb-2">Arrastra y suelta tus PDFs aquí</p>
                                                            ...
                                                            <Draggable key={file.id} draggableId={file.id} index={index}>
                                                                {(provided, snapshot) => (
                                                                    <div
                                                                        ...
                                                                        className={`p-3 bg-gradient-to-r from-red-50 to-pink-50 rounded-lg border transition-all duration-200 flex items-center space-x-3 ${snapshot.isDragging ? 'shadow-lg scale-105' : 'shadow-sm'}`}
                                                                    >
                                                                        <span className="bg-red-100 text-red-800 text-sm font-bold px-3 py-1 rounded-full">{index + 1}</span>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                ...
                                <div className="space-y-4">
                                    <button 
                                        ...
                                        className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 disabled:from-gray-400 disabled:to-gray-500 text-white py-4 px-8 rounded-xl transition-all duration-300 font-bold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:transform-none flex items-center justify-center space-x-2"
                                    >
                                        {isUploading ? (
                                            <>
                                    ...
                                    <button 
                                        type="button"
                                        onClick={handleGroupAndZip} 
                                        disabled={files.length === 0 || isUploading} 
                                        className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 disabled:from-gray-400 disabled:to-gray-500 text-white py-4 px-8 rounded-xl transition-all duration-300 font-bold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:transform-none flex items-center justify-center space-x-2"
                                    >
                                        {isUploading ? (
                                             <>
                                                <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
                                            ...
                                            <>
                                                ...
                                                <span>Agrupar y Descargar ZIP</span>
                                            </>
                                        )}
                                    </button>
                                </div>
                                ...
                                {uploadStatus && (
                                    <div className={`mt-4 p-4 rounded-lg font-medium text-center ${
                                        ...
                                        uploadStatus.includes('❌') ? 'bg-red-100 text-red-800 border border-red-200' :
